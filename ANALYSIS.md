...
- Severity: medium | Effort: M | Delight: 4 | Status: partly done (per-card `CARD_WORTH` measured from play, a stronger card-buying goal, discards by worth: 40 simulated 3p games buy 1.9 cards and play 1.3, from 0.6 and 0.3); Fog, Prophecy ordering and counter-when-leader open
